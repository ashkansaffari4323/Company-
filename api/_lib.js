...
function cleanTrade(value) {
  return clean(value) || process.env.DEFAULT_TRADE || 'Corporate & Professional Services';
}
...
function buildCompanyPayload(company) {
  ...
  // Only send name and a safe default trade. Do not send country/state/phone/ABN/ERP/address.
  return {
    name,
